...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if (array_key_exists($loginUsername, $accounts) && $accounts[$loginUsername] === $loginPassword) {
        ...
        if (isset($_POST['remember-me']) && $_POST['remember-me'] === 'on') {
            // Thiết lập cookie để lưu thông tin đăng nhập
            $cookie_name = "user_login";
            $cookie_value = $loginUsername; // Lưu tên người dùng vào cookie
            setcookie($cookie_name, $cookie_value, time() + (86400 * 30), "/"); // Cookie tồn tại trong 30 ngày
        }
                    ...
                    <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                        ...
                        <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                            <div class="form-group">
                                ...
                                <input type="text" name="register-username" id="register-username" class="form-control" pattern="[A-Za-z0-9]+"  required>
                            </div>
